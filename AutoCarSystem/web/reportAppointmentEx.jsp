...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>Appointment Exception Report</title>
...
<%         LocalDate poDate = java.time.LocalDate.now();
           ...
           ResultSet resultset = statement.executeQuery("select * from APPOINTMENT WHERE APPOINTMENT_DATE='"+poDate+"'") ;
...
%>
					...
					<table>
						<thead>
							<tr class="table100-head">
								...
								<th class="column2">APPOINTMENT DATE</th>
								<th class="column3">APPOINTMENT TIME</th>
                                                                <th class="column4">APPOINTMENT SERVICE</th>
								<th class="column5">APPOINTMENT STATUS</th>
								<th class="column6">VEHICLE ID</th>
                                                                <th class="column7">CUSTOMER ID</th>
							</tr>
						</thead>
						<tbody>
								</TR>
      ...
      <% } %>
            ...
            <form action="reportMain.jsp">
                <input type="submit" class="submit-btn" name="report" value="Back">
            </form>
