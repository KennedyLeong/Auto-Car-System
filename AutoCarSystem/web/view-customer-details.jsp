    ...
    <body>
        ...
        <div>
            <div class="customer-table">
                <label>Name
                    <input type="text" name="cname" class="customer-first-input" placeholder="<%= customer.getCustomerName()%>" readonly>
                </label><br>
            
                <label>Phone Number
                    <input type="text" name="cphonenumber" class="customer-second-input" placeholder="<%= customer.getCustomerPhoneNumber()%>" readonly>
                </label><br>
            
                <label>Email
                    <input type="text" name="cemail" class="customer-third-input" placeholder="<%= customer.getCustomerEmail()%>" readonly>
                </label><br>
                
                <label>Address
                    <input type="text" name="caddress" class="customer-fourth-input"placeholder="<%= customer.getCustomerAddress()%>" readonly>
                </label><br>
        ...
        <div>
            <div class="vehicle-table">
                <label>Plate Number
                    <input type="text" class="vehicle-first-input" name="" placeholder="" value="" readonly>
                </label><br>
            
                <label>Brand
                    <input type="text" class="vehicle-second-input" name="" placeholder="" readonly>
                </label><br>
            
                <label>Type
                    <input type="text" class="vehicle-third-input" name="" placeholder="" readonly>
                </label><br>
            
                <label>Color
                    <input type="text" class="vehicle-fourth-input" name="" placeholder="" readonly>
                </label><br>
            
                <label>Mileage 
                    <input type="text" class="vehicle-fifth-input" name="" placeholder="" readonly>
                </label><br>
            </div>
