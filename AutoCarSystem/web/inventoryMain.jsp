...
%>
      ...
      <% } %>
            ...
            <form action="stockMenu.jsp" method="post" >
                <input type="submit" class="submit-btn" value = "Manage Stocks" name="stock" style="float:left;margin-top:-20px;" >
            </form>
             
            <form action="supplier.jsp" method="post" ">
                <input type="submit" class="submit-btn" value = "Manage Suppliers" name="supplier" style="float:left;margin-top:-20px;" >
            </form> 
                
            <form action="procurement.jsp" method="post" >
                <input type="submit" class="submit-btn" value = "Procurement" name="procurement" style="float:left;margin-top:-20px;" >
            </form> 
                
            <form action="reportMain.jsp" method="post">
                <input type="submit" class="submit-btn" value = "Generate Report" name="report" style="float:left;margin-top:-20px;" >
            </form>
