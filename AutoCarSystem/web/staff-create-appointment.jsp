<%-- 
    Document   : staff-create-appointment
    Created on : Jan 20, 2021, 9:57:58 PM
    Author     : asus
--%>
...
<html>
    ...
    <form action="StaffCreateAppointment" method="POST" id="appointmentform">
    ...
    <div class="appointment-tbl"> 
        ...
        <input type ="textbox" name="vnumber" class="vehicle-No-Input" required=""><br>
