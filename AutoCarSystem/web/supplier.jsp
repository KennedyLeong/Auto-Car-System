  ...
  padding:10px 50px 50px;
    ...
    <body>
      ...
      <% } %>
        ...
        <h1 style="float:left">Suppliers</h1>
        <div class="container p-3 my-3 border" style="float:bottom">
            
            <div class="container">
                
                <div class="group" style="bottom:15px">      
                    <strong style="font-family:Roboto;font-size: 20px">Supplier Information</strong>
                </div>
            ...
            <form action="supplierManage" method="post">
                ...
                <div class="group">      
                    <input type="text" name="supplierID" id="supplierID" value="<%="SP"+count %>" >
                ...
                <div class="group">      
                    <input type="text" name="supplierName" maxlength="50">
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <label>Name</label>
                </div>
                ...
                <div class="group">      
                    <input type="text" name="supplierAddress" maxlength="50">
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <label>Address</label>
                </div>
                ...
                <div class="group">      
                    <input type="email" name="supplierContact" maxlength="20" >
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <label>Contact</label>
                </div>
                ...
                <input type="submit" class="submit-btn" value = "Update Supplier" name="updatesupplier"  >
                <input type="submit" class="submit-btn" value = "Delete Supplier" name="deletesupplier"  >
