...
%>
					...
					<table>
						<thead>
							<tr class="table100-head">
								...
								<th class="column2">Transaction Date</th>
								<th class="column3">Transaction Amount</th>
								<th class="column4">Appointment ID</th>
							</tr>
						</thead>
						<tbody>
								</TR>
      ...
      <% } %>
                ...
                <input type="submit" class="submit-btn" value = "Back" name="stock" style="float:left;margin-top:-20px;margin-left: 20px;" >
            </form>
